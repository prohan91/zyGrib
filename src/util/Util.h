...
class Util : public QObject
{
	...
	static QString pathColors () {return "data/colors/";}
	static QString pathConfig () {return "data/config/";}
	static QString pathFonts ()  {return "data/fonts/";}
	static QString pathGis ()    {return "data/gis/";}
	static QString pathGshhs ()  {return "data/maps/gshhs/";}
	static QString pathStuff ()  {return "data/stuff/";}
	
	static QString pathImg (const char *fname) {return QString("data/img/")+fname;}
	static QString pathTr  (QString lang)   {return QString("data/tr/zyGrib_")+lang;}
